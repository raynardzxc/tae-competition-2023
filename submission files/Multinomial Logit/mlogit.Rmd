...
write.csv(df_train_final, file = "./train1_onehot2.csv", row.names = FALSE)
...
# Writing the output to a csv file
write.csv(df_test_final, file = "./test1_onehot2.csv", row.names = FALSE)
```

## Import Data
```{r}
safety <- read.csv("./train1_onehot2.csv")
head(safety)
```
...
```{r}
predict_data <- read.csv("./test1_onehot2.csv")
...
# Writing the output to a csv file
write.csv(prediction_df, file = "../output/submission_MNL.csv", row.names = FALSE)
```
