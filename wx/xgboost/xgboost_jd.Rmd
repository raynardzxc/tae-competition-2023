...
totrain$Choice <- NULL
totrain <- subset(totrain, select = c(Task, Price3, Price2, as.factor(income), Price1, agea, incomea, milesa, nighta, year, yearind, incomeind, as.factor(miles), milesind, nightind, as.factor(night), pparkind, as.factor(ppark), as.factor(segment), segmentind, as.factor(region), regionind, BU3))
```
...
str(inds)
train.data = as.matrix(subset(totrain[inds$train, ], select = -c(Task)))
train.label = label[inds$train]
test.data = as.matrix(subset(totrain[inds$test, ],select = -c(Task)))
...
predict_set <- subset(totrain, select = c(Task, Price3, Price2, as.factor(income), Price1, agea, incomea, milesa, nighta, year, yearind, incomeind, as.factor(miles), milesind, nightind, as.factor(night), pparkind, as.factor(ppark), as.factor(segment), segmentind, as.factor(region), regionind, BU3))
