...
## iterate with many combinations
...
best <- model <- soft_voting(pred1, pred2, pred3, weights = c(0.5, 0.3, 0.2))
...
allowance <- 0.01 ## CHANGE THIS: higher means a larger range, public score will deviate much more
...
```{r}
finalresult <- subset(result_frame, result_frame$cat=="Close to Benchmark and more confident")
finalresult
```
