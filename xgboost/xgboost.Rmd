...
```{r}
train_set_1 <- subset(train_set, select = c(Price2,Price3,Price1,incomeind,nightind,ageind,pparkind,milesind,yearind,segmentind,regionind,educind,Urbind,NV1,Choice))
test_set_1 <- subset(test_set, select = c(Price2,Price3,Price1,incomeind,nightind,ageind,pparkind,milesind,yearind,segmentind,regionind,educind,Urbind,NV1,Choice))
```

```{r}
which(colnames(train_set_1)=="Price2")
choicecol<-which(colnames(train_set_1)=="NV1")+1
choicecol
```
